		...
		<div id="list-producto" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="ingredientes" title="${message(code: 'producto.ingredientes.label', default: 'Ingredientes')}" />
				...
				<g:each in="${productoInstanceList}" status="i" var="productoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: productoInstance, field: "ingredientes")}</td>
