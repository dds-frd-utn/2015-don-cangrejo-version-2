	...
	<body>
		...
		<div id="show-producto" class="content scaffold-show" role="main">
			...
			<ol class="property-list producto">
				...
				<g:if test="${productoInstance?.ingredientes}">
				<li class="fieldcontain">
					<span id="ingredientes-label" class="property-label"><g:message code="producto.ingredientes.label" default="Ingredientes" /></span>
					
						<span class="property-value" aria-labelledby="ingredientes-label"><g:fieldValue bean="${productoInstance}" field="ingredientes"/></span>
